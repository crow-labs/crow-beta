...
func (m *BasicEscrow) GetEscrowId() uint64 {
	if m != nil {
		return m.EscrowId
	}
	return 0
...
var fileDescriptor_94f7c066a3eb676f = []byte{
	...
	,
}
...
func (m *BasicEscrow) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EscrowId != 0 {
		i = encodeVarintBasicEscrow(dAtA, i, uint64(m.EscrowId))
		i--
		dAtA[i] = 0x8
	}
...
func (m *BasicEscrow) Size() (n int) {
	...
	_ = l
	if m.EscrowId != 0 {
		n += 1 + sovBasicEscrow(uint64(m.EscrowId))
	}
	l = len(m.Address)
	if l > 0 {
