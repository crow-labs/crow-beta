...
import CrowCrowEscrow from './crow/crow.escrow'
import CrowCrowMarketplace from './crow/crow.marketplace'
import CrowCrowWhitelist from './crow/crow.whitelist'
...
export default { 
  ...
  CrowCrowEscrow: load(CrowCrowEscrow, 'crow.escrow'),
  CrowCrowMarketplace: load(CrowCrowMarketplace, 'crow.marketplace'),
  CrowCrowWhitelist: load(CrowCrowWhitelist, 'crow.whitelist'),
